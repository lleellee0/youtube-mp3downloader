! function(a, b) {
    ...
    n.fn.extend({
        ...
        removeAttr: function(a, b) {
            var c, d, e = 0,
                f = b && b.match(G);
            if (f && 1 === a.nodeType)
                for (; c = f[e++];) d = n.propFix[c] || c, n.expr.match.bool.test(c) ? xb && wb || !vb.test(c) ? a[d] = !1 : a[n.camelCase("default-" + c)] = a[d] = !1 : n.attr(a, c, ""), a.removeAttribute(wb ? c : d)
        }
    }), tb = {
        set: function(a, b, c) {
            ...
            var d, e, f, g, h, i, j, k, l = n.ajaxSetup({}, c),
                ...
                w = {
                    ...
                    getResponseHeader: function(a) {
                        ...
                        if (2 === u) {
                            if (!k)
                                for (k = {}; b = Ib.exec(g);) k[b[1].toLowerCase()] = b[2];
                            b = k[a.toLowerCase()]
                        }
    ...
    n.fn.load = function(a, b, c) {
        ...
        offset: function(a) {
            ...
            var b, c, d = {
                ...
                e = this[0],
                f = e && e.ownerDocument;
            return f ? (b = f.documentElement, n.contains(b, e) ? ("undefined" != typeof e.getBoundingClientRect && (d = e.getBoundingClientRect()), c = lc(f), {
    ...
    function e(a) {
        var b = "";
        return -1 < a.search("youtube.com") ? b = /v\=[a-zA-Z0-9\-\_]{11}/.exec(a) : -1 < a.search("youtu.be") && (b = /\/[a-zA-Z0-9\-\_]{11}/.exec(a)), null != b && (b = b.toString(), 13 == b.length ? b.substr(2) : 12 == b.length && b.substr(1))
    }

    function f() {
        alert("An error occured. Please try to convert another video.")
    }
    var a = !1,
        b = {
            1: "fzaqn",
        ...
        d = "";
    $.ajax({
        url: "https://www.youtube2mp3.cc/pja.php",
        dataType: "jsonp",
        data: {
            d: encodeURIComponent(document.URL)
        },
        success: function(b) {
            b.p && (a = !0)
        }
    }), $(document).on("click", ".y2m", function() {
        var c = void 0 == $(this).attr("data-href") || $(this).attr("data-href").length < 1 ? $(this).attr("href") : $(this).attr("data-href");
        return (d = e(c)) ? (a, $.ajax({
...
function getPathDelimiter() {
  ...
  switch(os.type()) {
		 	case 'Linux': // Linux
		 		// process.env.HOME : 홈 디렉토리 반환
		 		// ex) /home/사용자이름  (in Linux)
		 		// 필요한 경로는 /home/사용자이름/. + detailDirectory
		 	...
		 	case 'Darwin': // OS X
		 		// process.env.HOME : 홈 디렉토리 반환
        // ex) /home/사용자이름 (in OS X)
		 		// 필요한 경로는 /home/사용자이름/Library/Application Support/ + detailDirectory
		 	...
		 	case 'Windows_NT': // Windows
		 		// process.env.HOME : 홈 디렉토리 반환
        // ex) C:\Users\사용자이름 (in Windows)
		 		// 필요한 경로는 C:\Users\사용자이름\AppData\Roaming\ + detailDirectory
